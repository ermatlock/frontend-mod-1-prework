...
// EXPLAIN:
// For the second example the console is returning the incremental values of each `i` in the loop. This code is running the loop three times `i < 3` The initial value is 0, then in loop 2 the value is 1, then finally in loop three the value is 2.
