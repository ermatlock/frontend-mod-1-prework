...
zooAnimals.Parrots = 10;
console.log(zooAnimals);

// Change the value for at least one of your animal keys, and log the updated Object.
zooAnimals.Giraffes = 4;
zooAnimals.Chimpanzees = 3;
console.log(zooAnimals)
...
var singleEmail = {
  senderName: 'Eric Matlock',
  senderAddress: 'ermatlock@gmail.com',
  recipientName: 'Eric Weissman',
  recipientAddress: 'eric@turing.edu',
  subjectLine: 'Working on section 4',
  ccAddress: ['margo@turing.edu', 'mason@turing.edu'],
  sent: false
};
...
var emails = [
  ...
  senderName: 'Eric Matlock',
  senderAddress: 'ermatlock@gmail.com',
  recipientName: 'Emily Koren',
  recipientAddress: 'erkk4@hotmail.com',
  subjectLine: 'Our puppy',
  ccAddress: ['lindysue@gmail.com'],
  sent: true
  },
  {
  senderName: 'Eric Matlock',
  senderAddress: 'ermatlock@gmail.com',
  recipientName: 'Rosana Matlock',
  recipientAddress: 'rmat@gmail.com',
  subjectLine: 'When can we visit?',
